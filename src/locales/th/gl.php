...
//resources
$gl['resources']=array(
 0=>array('name'=>'gold', 'description'=>'ทองจะได้จากการทำเหมืองทอง'),
 1=>array('name'=>'lumber', 'description'=>'ไม้จะได้จากการเลือยไม้'),
 2=>array('name'=>'iron', 'description'=>'เหล็กจะได้จากการทำเหมืองเหล็ก'),
 3=>array('name'=>'workers', 'description'=>'แรงงานขับเคลื่อนเศรษฐกิจ'),
 4=>array('name'=>'storage space', 'description'=>'คลังเก็บพัสดุ'),
 5=>array('name'=>'food', 'description'=>'เสบียงสำหรับกำลังพล')
);
//factions
$gl['factions']=array(
 0=>array('name'=>'Empire', 'description'=>'สมดุลระหว่างการทหารและเศรษฐกิจ'),
 1=>array('name'=>'Guild', 'description'=>'เชียวชาญทางด้านเศรษฐกิจ'),
 2=>array('name'=>'Order', 'description'=>'เชียวชาญทางด้านการทหาร')
);
...
$gl['modules']=array(
 0=>array(
  0=>array('name'=>'เหมืองทอง', 'description'=>'Gold mines produce gold.'),
  1=>array('name'=>'โรงเลือยไม้', 'description'=>'Lumber mills harvest lumber.'),
  2=>array('name'=>'เหมืองเหล็ก', 'description'=>'Iron mines produce iron.'),
  3=>array('name'=>'โรงงานผลิตเกราะ', 'description'=>'Armor is forged here.'),
  4=>array('name'=>'โรงงานผลิตอาวุธ', 'description'=>'Weapons are forged here.'),
  5=>array('name'=>'ค่ายทหาร', 'description'=>'Infantry units are trained here.'),
  6=>array('name'=>'คอกม้า', 'description'=>'Mounted units are trained here.'),
  7=>array('name'=>'ซุ้มทหารรับจ้าง', 'description'=>'Hire units for gold.'),
  8=>array('name'=>'มหาวิทยาลัย', 'description'=>'New technologies are researched here.'),
  9=>array('name'=>'ตลาด', 'description'=>'Trade components and resources.'),
  10=>array('name'=>'คลังมหาสมบัติ', 'description'=>'Stores extra gold.'),
  11=>array('name'=>'โกดังไม้', 'description'=>'Stores extra lumber.'),
  12=>array('name'=>'โกดังเหล็ก', 'description'=>'Stores extra iron.')
 ),
 1=>array(
  0=>array('name'=>'เหมืองทอง', 'description'=>'Gold mines produce gold.'),
  1=>array('name'=>'โรงเลือยไม้', 'description'=>'Lumber mills harvest lumber.'),
