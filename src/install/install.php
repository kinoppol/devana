...
<?php include 'templates/'.$_SESSION[$shortTitle.'User']['template'].'/header.php'; ?>
  <div class="content">
   <form method="post" action="install.php">
    ...
    <div><div class="cell"><?php echo $ui['securityCode']; ?></div><div class="cell"><div class="cell"><?php print $_SESSION['regCode']; ?><img style="vertical-align: bottom;" src="../captcha.php"></div><div class="cell"><input class="textbox" type="text" size="4" name="regCode"></div></div></div>
